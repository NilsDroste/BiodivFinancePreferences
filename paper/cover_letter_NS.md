...
The test is demanding by design. Sweden ranks fifth of 91 countries on interpersonal trust, so citizens have little reason to doubt that others would contribute, while its public biodiversity spending is among the lowest in Europe, so the state cannot be seen as already covering the problem. Both leading alternative explanations are therefore closed off, which is what makes a null result here informative beyond the case itself.

The finding cuts against the prevailing justification for the current architecture. Voluntary biodiversity finance is often defended as the pragmatic option, on the assumption that public appetite for regulation is limited. Our evidence indicates the binding constraint is not citizen unwillingness to be governed or to pay.
